                            ...
                            <tbody>
                                @forelse ( $detailNota as $item)
                                      <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">Motherboard</td>                        
                                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                Asus
                                            </td>
                                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">Gudang Lab 01</td>

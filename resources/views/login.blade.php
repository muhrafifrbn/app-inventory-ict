          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            @endif
              ...
              <form class="space-y-4 md:space-y-6" method="POST" action="/login">
                @csrf
                  <div>
                      <label for="nim" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIM / NIP</label>
                      <input type="text" name="nim_nip" id="nim" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan NIM/NIP" required="">
                  </div>
                  <div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Belum Punya Akun ? <a href="/registrasi" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Registrasi</a>
                  </p>
              </form>
          </div>
      </div>
